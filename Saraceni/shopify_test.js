                    ...
                    .then(res => {
                        ...
                        return client.checkout.addLineItems(checkoutId, lineItemsToAdd).then((checkout) => {
                            ...
                            .then(res => {
                                ...
                                return client.checkout.updateLineItems(checkoutId, lineItemsToUpdate).then((checkout_2) => {
                                        // Do something with the updated checkout
                                        console.log("checkout_2.lineItems 2 ---> ", checkout_2.lineItems); // Array with one additional line item
                                        return;
